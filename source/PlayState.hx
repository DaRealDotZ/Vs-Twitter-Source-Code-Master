	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'schoolEvil': //Week 6 - Thorns
			 ...
			 case 'drop': //Week T
	        	 if(!ClientPrefs.lowQuality) {
                  var bg:BGSprite = new BGSprite('drop_bg', -600, -200, 0.9, 0.9);
				  bg.antialiasing = false;
				  add(bg);
		        } else {
	        	  var bg:BGSprite = new BGSprite('drop_bg', -600, -200, 0.9, 0.9);
		    ...
		    case 'drop_Hellish': //Week T - Cancellation
	        	 if(!ClientPrefs.lowQuality) {
                  var bg:BGSprite = new BGSprite('drop_bg_Hellish', -600, -200, 0.9, 0.9);
				  bg.antialiasing = false;
				  add(bg);
		        } else {
	        	  var bg:BGSprite = new BGSprite('drop_bg_Hellish', -600, -200, 0.9, 0.9);
			...
			case 'drop_Nevada': //Twittergation
				if(!ClientPrefs.lowQuality) {
				 var bg:BGSprite = new BGSprite('drop_bg_Nevada', -600, -200, 0.9, 0.9);
				 bg.antialiasing = false;
				 add(bg);
			   } else {
				 var bg:BGSprite = new BGSprite('drop_bg_Nevada', -600, -200, 0.9, 0.9);
